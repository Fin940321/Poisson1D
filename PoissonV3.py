...
electrolyte_charge_file = folder1 + "hist_q_total_2V.dat"
electrode_charge_file = folder1 + "charges_output_2V.dat"
...
# plt.title("Electric Field of Poisson potential under 2V")
# plt.xlabel("Z Position (Å)")
# plt.ylabel("Electric field (e/bohr^2)")
# plt.ylim(-0.03, 0.015)
# plt.plot(z1_dist,E_z)
# # Electrode position markers
# plt.axvline(x=z_left, color='green', linestyle='--', linewidth=2, alpha=0.7, label=f'Cathode ({z_left:.1f} Å)')
# plt.axvline(x=z_right, color='orange', linestyle='--', linewidth=2, alpha=0.7, label=f'Anode ({z_right:.1f} Å)')
# plt.legend(loc='best')
# plt.savefig('Electricfield_Poisson_2V.png', dpi=600, bbox_inches='tight')
...
# plt.subplot(313)
# plt.figure(figsize=(6, 6))
plt.title("Voltage of Poisson potential under 2V")
plt.xlabel("Z Position (Å)")
...
plt.axvline(x=z_right, color='orange', linestyle='--', linewidth=2, alpha=0.7, label=f'Anode ({z_right:.1f} Å)')
plt.legend(loc='best')
plt.savefig('Voltage_Poisson_2V.png', dpi=600, bbox_inches='tight')
