...
def compute_poisson_profile(config):
    ...
    # 定義 Bulk 的 Z 軸物理範圍 (與你在 main 裡面設定的一致)
    bulk_z_min = 70.0
    bulk_z_max = 100.0
...
def main():
    ...
    efield_filename = 'Electricfield_Poisson_overlayV3.png'
    ...
    voltage_filename = 'Voltage_Poisson_overlayV3.png'
    ...
    plt.tight_layout()
    combined_filename = 'Poisson_combined_overlayV3.png'
